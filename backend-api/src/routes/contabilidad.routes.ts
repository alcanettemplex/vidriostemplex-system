...
import { getResumenFinanciero, getPagos, getPagosPorODP, registrarPago, editarPago, eliminarPago, getContabilidadODPs } from '../controllers/contabilidad.controller';

const router = Router();

// Acceso: admin, gerencia, contabilidad
router.get('/odps', authMiddleware, requireRole('admin', 'gerencia', 'contabilidad', 'asistente_administrativo'), getContabilidadODPs);
