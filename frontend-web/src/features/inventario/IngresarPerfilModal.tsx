...
import { X, Plus, Trash2, Search, PackagePlus, AlertCircle } from '../../components/ui/icons';
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-6xl flex flex-col h-[95vh] border border-slate-200">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-slate-900">Ingresar Perfilería</h2>
          </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-200">
                <th className="pb-2 text-left text-xs font-semibold text-slate-900 uppercase w-[45%]">Código / Nombre *</th>
