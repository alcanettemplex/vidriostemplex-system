    ...
    return (
        <div className="print-root block w-[21.5cm] min-h-[29cm] print:min-h-0 bg-white shadow-xl print:shadow-none text-black font-sans text-[10px] mx-auto overflow-hidden print:overflow-visible">
            <style>
                ...
                @media print {
                    @page { size: letter portrait; margin: 2mm; }
            ...
            {hasContinuacion && (
                <div className="print-container p-2 print:p-0">
                    ...
                    <table className="excel-table mb-2">
                        <tbody>
                            <tr>
                                <td className="font-bold w-12 text-center uppercase bg-yellow-50">CANT</td>
                                <td className="font-bold text-center uppercase tracking-widest bg-yellow-50">
                                    PRODUCTO O SERVICIO (CONTINUACIÓN)
                                </td>
                            </tr>
                            {svcCont.map((svc: any, idx: number) => (
                                <tr key={idx}>
