...
import { X, FileText, FileCheck } from '../../../components/ui/icons';
      ...
      <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100">
            <h2 className="text-base font-bold text-slate-900">Tipo de Orden</h2>
          ...
          <div className="p-6 space-y-4">
            <p className="text-sm font-semibold text-slate-900">¿Qué tipo de orden vas a crear?</p>

            <div className="grid grid-cols-2 gap-3">
              {/* ODP normal */}
              <button
                onClick={() => onConfirm('ODP')}
                className="flex flex-col items-center gap-3 p-5 rounded-xl border-2 border-slate-200 text-slate-700
