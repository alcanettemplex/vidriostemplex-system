              ...
              >
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                  <div>
                    ...
                    {pendiente.codigo_derivado && (
                      <div style={{ fontSize: FONT.tiny, color: '#b45309', marginTop: 4, display: 'flex', alignItems: 'center', gap: 3 }}>
                ...
                <label
                  style={{
                    ...
                    padding: 10, background: 'rgba(99, 102, 241, 0.06)', borderRadius: RADIUS.md,
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                ...
                {creandoProducto ? (
                  <div
                    style={{
                      ...
                      borderRadius: RADIUS.xl, padding: 14, display: 'flex', flexDirection: 'column', gap: 10,
                    }}
                  >
                    ...
                    <label style={{ display: 'flex', alignItems: 'center', gap: 7, fontSize: FONT.sm, cursor: 'pointer' }}>
                      <input
                        type="checkbox"
                ...
                {productoSeleccionado && (
                  ...
                  >
                    ...
                    {loadingPreciosComp ? (
                      <div style={{ fontSize: FONT.sm, color: 'var(--text-muted)', display: 'flex', alignItems: 'center', gap: 6 }}>
                        <Loader2 size={12} className="animate-spin" /> Verificando otros proveedores…
                      </div>
                    ) : preciosComparativos.length > 0 ? (
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                        <div style={{ fontSize: FONT.xs, color: 'var(--text-muted)' }}>Ya lo compras a:</div>
                      ...
                      <div style={{ fontSize: FONT.xs, color: 'var(--text-muted)' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 12, marginTop: 4 }}>
                  <div>
                    ...
                    {pendiente.unidad_detectada && pendiente.unidad_detectada !== unidadCompra && (
                      <div style={{ fontSize: FONT.tiny, color: '#b45309', marginTop: 4 }}>
