    ...
    <div className="p-4 sm:p-6 lg:p-8 w-full min-h-screen bg-slate-50">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-6">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {error && (
            <span className="text-[12px] font-semibold bg-rose-100 text-rose-700 px-2 py-1 rounded border border-rose-200">
              Error de conexión
            </span>
          )}
          ...
          <div className="flex items-center gap-1.5 bg-white border border-slate-200 rounded-xl shadow-card px-3 py-1.5">
            ...
            <select
              ...
              className="bg-transparent text-[12px] font-semibold text-slate-900 outline-none cursor-pointer"
            >
            ...
            <span className="text-[11px] font-semibold text-slate-900 uppercase tracking-wide">Hasta</span>
            <select
              value={period.mesFin}
          ...
          <button
            ...
            className={`p-2 bg-white border border-slate-200 rounded-lg shadow-card text-slate-700 hover:text-indigo-600 hover:bg-indigo-50 transition-colors focus:outline-none ${isRefreshing ? 'animate-spin text-indigo-500' : ''}`}
